  ...
  <Card class="w-full">
    <CardHeader>
      ...
      <CardDescription class="space-y-2">
        ...
        <div>
          {{ graphStoreService.getComment(selected) }}
        </div>
      </CardDescription>
    </CardHeader>
    <CardContent>
      <div class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            >
              <div class="grid grid-cols-3 gap-4 mb-2">
                ...
                <div>
                  <p class="text-sm font-medium text-muted-foreground">URI</p>
                  <Badge
                    variant="outline"
        ...
        <div>
          ...
          <p class="text-muted-foreground">No restrictions defined.</p>
        </div>
